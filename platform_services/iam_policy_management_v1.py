...
class IamPolicyManagementV1(BaseService):
    ...
    def list_policies(self, account_id: str, *, accept_language: str = None, iam_id: str = None, access_group_id: str = None, type: str = None, service_type: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_policies')
    ...
    def create_policy(self, type: str, subjects: List['PolicyRequestSubjectsItem'], roles: List['PolicyRequestRolesItem'], resources: List['PolicyRequestResourcesItem'], *, accept_language: str = None, **kwargs) -> DetailedResponse:
        """
        Create a policy.
        ...
        **`accountId`** attributes.
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `PolicyResponse` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='create_policy')
        headers.update(sdk_headers)
    ...
    def update_policy(self, policy_id: str, if_match: str, type: str, subjects: List['PolicyRequestSubjectsItem'], roles: List['PolicyRequestRolesItem'], resources: List['PolicyRequestResourcesItem'], **kwargs) -> DetailedResponse:
        """
        Update a policy.
        ...
        **`accountId`** attributes.
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='update_policy')
        headers.update(sdk_headers)
        ...
        url = '/v1/policies/{0}'.format(*self.encode_path_vars(policy_id))
    ...
    def get_policy(self, policy_id: str, **kwargs) -> DetailedResponse:
        ...
        if policy_id is None:
            raise ValueError('policy_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_policy')
        headers.update(sdk_headers)
    ...
    def delete_policy(self, policy_id: str, **kwargs) -> DetailedResponse:
        ...
        if policy_id is None:
            raise ValueError('policy_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='delete_policy')
        headers.update(sdk_headers)
    ...
    def list_roles(self, *, accept_language: str = None, account_id: str = None, service_name: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_roles')
        headers.update(sdk_headers)
    ...
    def create_role(self, name: str, account_id: str, service_name: str, display_name: str, actions: List[str], *, description: str = None, accept_language: str = None, **kwargs) -> DetailedResponse:
        """
        Create a role.
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `CustomRoleResponse` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='create_role')
        headers.update(sdk_headers)
    ...
    def update_role(self, role_id: str, if_match: str, *, display_name: str = None, description: str = None, actions: List[str] = None, **kwargs) -> DetailedResponse:
        """
        Update a role.
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='update_role')
        headers.update(sdk_headers)
        ...
        url = '/v2/roles/{0}'.format(*self.encode_path_vars(role_id))
        request = self.prepare_request(method='PUT',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def get_role(self, role_id: str, **kwargs) -> DetailedResponse:
        ...
        if role_id is None:
            raise ValueError('role_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_role')
        headers.update(sdk_headers)
    ...
    def delete_role(self, role_id: str, **kwargs) -> DetailedResponse:
        ...
        if role_id is None:
            raise ValueError('role_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='delete_role')
        headers.update(sdk_headers)
...
class PolicyBaseResourcesItem():
    ...
    def __init__(self, *, attributes: List['PolicyBaseResourcesItemAttributesItem'] = None) -> None:
        """
...
class PolicyBaseResourcesItemAttributesItem():
    ...
    def __init__(self, *, name: str = None, value: str = None, operator: str = None) -> None:
        """
...
class PolicyBaseSubjectsItem():
    ...
    def __init__(self, *, attributes: List['PolicyBaseSubjectsItemAttributesItem'] = None) -> None:
        """
...
class PolicyRequestResourcesItem():
    ...
    def __init__(self, attributes: List['PolicyRequestResourcesItemAttributesItem']) -> None:
        """
...
class PolicyRequestSubjectsItem():
    ...
    def __init__(self, attributes: List['PolicyRequestSubjectsItemAttributesItem']) -> None:
        """
...
class PolicyResponseRolesItem():
    """
    PolicyResponseRolesItem.
    ...
    def __init__(self, *, role_id: str = None, display_name: str = None, description: str = None) -> None:
        """
        Initialize a PolicyResponseRolesItem object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'PolicyResponseRolesItem':
        """Initialize a PolicyResponseRolesItem object from a json dictionary."""
        args = {}
        if 'role_id' in _dict:
            args['role_id'] = _dict.get('role_id')
    ...
    def __str__(self) -> str:
        """Return a `str` version of this PolicyResponseRolesItem object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'PolicyResponseRolesItem') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'PolicyResponseRolesItem') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class RoleListCustomRolesItem():
    ...
    def __init__(self, *, id: str = None, name: str = None, account_id: str = None, service_name: str = None, crn: str = None, display_name: str = None, description: str = None, actions: List[str] = None, created_at: datetime = None, created_by_id: str = None, last_modified_at: datetime = None, last_modified_by_id: str = None, href: str = None) -> None:
        """
        ...
        :param str crn: (optional) The role CRN.
        :param str display_name: (optional) The display name of the role that is
               shown in the console.
        :param str description: (optional) The description of the role.
        :param List[str] actions: (optional) The actions of the role.
...
class RoleListServiceRolesItem():
    ...
    def __init__(self, *, crn: str = None, display_name: str = None, description: str = None, actions: List[str] = None) -> None:
        """
...
class CustomRoleResponse():
    ...
    def __init__(self, *, id: str = None, name: str = None, account_id: str = None, service_name: str = None, crn: str = None, display_name: str = None, description: str = None, actions: List[str] = None, created_at: datetime = None, created_by_id: str = None, last_modified_at: datetime = None, last_modified_by_id: str = None, href: str = None) -> None:
        """
        Initialize a CustomRoleResponse object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'CustomRoleResponse':
        """Initialize a CustomRoleResponse object from a json dictionary."""
        args = {}
        if 'id' in _dict:
            args['id'] = _dict.get('id')
        if 'name' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this CustomRoleResponse object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'CustomRoleResponse') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'CustomRoleResponse') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class PolicyList():
    ...
    :attr List[PolicyResponse] policies: (optional) List of policies.
    """

    def __init__(self, *, policies: List['PolicyResponse'] = None) -> None:
        """
        Initialize a PolicyList object.

        :param List[PolicyResponse] policies: (optional) List of policies.
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'PolicyList':
        ...
        if 'policies' in _dict:
            args['policies'] = [PolicyResponse.from_dict(x) for x in _dict.get('policies')]
        return cls(**args)
...
class PolicyResponse():
    ...
    :attr List[PolicyBaseSubjectsItem] subjects: (optional) The subject attribute
          values that must match in order for this policy to apply in a permission
          decision.
    :attr List[PolicyResponseRolesItem] roles: (optional) A set of role cloud
          resource names (CRNs) granted by the policy.
    ...
    def __init__(self, *, id: str = None, type: str = None, subjects: List['PolicyBaseSubjectsItem'] = None, roles: List['PolicyResponseRolesItem'] = None, resources: List['PolicyBaseResourcesItem'] = None, href: str = None, created_at: datetime = None, created_by_id: str = None, last_modified_at: datetime = None, last_modified_by_id: str = None) -> None:
        """
        Initialize a PolicyResponse object.
        ...
        :param List[PolicyBaseSubjectsItem] subjects: (optional) The subject
               ...
               permission decision.
        :param List[PolicyResponseRolesItem] roles: (optional) A set of role cloud
               resource names (CRNs) granted by the policy.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'PolicyResponse':
        """Initialize a PolicyResponse object from a json dictionary."""
        args = {}
        if 'id' in _dict:
            args['id'] = _dict.get('id')
        if 'type' in _dict:
        ...
        if 'roles' in _dict:
            args['roles'] = [PolicyResponseRolesItem.from_dict(x) for x in _dict.get('roles')]
    ...
    def __str__(self) -> str:
        """Return a `str` version of this PolicyResponse object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'PolicyResponse') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'PolicyResponse') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class RoleList():
    ...
    def __init__(self, *, custom_roles: List['RoleListCustomRolesItem'] = None, service_roles: List['RoleListServiceRolesItem'] = None, system_roles: List['RoleListSystemRolesItem'] = None) -> None:
        """
