...
class OpenServiceBrokerV1(BaseService):
    ...
    def get_service_instance_state(self, instance_id: str, **kwargs) -> DetailedResponse:
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_service_instance_state')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/bluemix_v1/service_instances/{0}'.format(*self.encode_path_vars(instance_id))
    ...
    def replace_state(self, instance_id: str, *, enabled: bool = None, initiator_id: str = None, reason_code: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if instance_id is None:
            raise ValueError('instance_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='replace_state')
        headers.update(sdk_headers)
    ...
    def replace_service_instance(self, instance_id: str, *, organization_guid: str = None, plan_id: str = None, service_id: str = None, space_guid: str = None, context: List['Context'] = None, parameters: List['Parameters'] = None, accepts_incomplete: bool = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='replace_service_instance')
        headers.update(sdk_headers)
        ...
        url = '/v2/service_instances/{0}'.format(*self.encode_path_vars(instance_id))
        request = self.prepare_request(method='PUT',
                                       url=url,
                                       headers=headers,
                                       params=params,
    ...
    def update_service_instance(self, instance_id: str, *, service_id: str = None, context: List['Context'] = None, parameters: 'Parameters' = None, plan_id: str = None, previous_values: List[str] = None, accepts_incomplete: str = None, **kwargs) -> DetailedResponse:
        """
    ...
    def delete_service_instance(self, service_id: str, plan_id: str, instance_id: str, *, accepts_incomplete: bool = None, **kwargs) -> DetailedResponse:
        """
        ...
        if instance_id is None:
            raise ValueError('instance_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='delete_service_instance')
        headers.update(sdk_headers)
    ...
    def list_catalog(self, **kwargs) -> DetailedResponse:
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_catalog')
        headers.update(sdk_headers)
    ...
    def list_last_operation(self, instance_id: str, *, operation: str = None, plan_id: str = None, service_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if instance_id is None:
            raise ValueError('instance_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_last_operation')
        headers.update(sdk_headers)
        ...
        url = '/v2/service_instances/{0}/last_operation'.format(*self.encode_path_vars(instance_id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers,
                                       params=params)
    ...
    def replace_service_binding(self, binding_id: str, instance_id: str, *, bind_resource: List['BindResource'] = None, parameters: object = None, plan_id: str = None, service_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        **Note:** Brokers that do not offer any bindable services do not need to implement
        ...
        if parameters is not None:
            parameters = convert_model(parameters)
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='replace_service_binding')
        headers.update(sdk_headers)
        ...
        url = '/v2/service_instances/{0}/service_bindings/{1}'.format(*self.encode_path_vars(binding_id, instance_id))
        request = self.prepare_request(method='PUT',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def delete_service_binding(self, binding_id: str, instance_id: str, plan_id: str, service_id: str, **kwargs) -> DetailedResponse:
        """
        ...
        **Note**: Brokers that do not provide any bindable services or plans do not need
        ...
        if service_id is None:
            raise ValueError('service_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='delete_service_binding')
        headers.update(sdk_headers)
...
class BindResource():
    ...
    def __init__(self, *, account_id: str = None, serviceid_crn: str = None, target_crn: str = None) -> None:
        """
...
class Parameters():
    ...
    def __init__(self, *, parameter1: int = None, parameter2: str = None) -> None:
        """
...
class Services():
    ...
    def __init__(self, bindable: bool, description: str, id: str, name: str, plans: List['Plans'], *, plan_updateable: bool = None) -> None:
        """
