...
class ResourceControllerV2(BaseService):
    ...
    def list_resource_instances(self, *, guid: str = None, name: str = None, resource_group_id: str = None, resource_id: str = None, resource_plan_id: str = None, type: str = None, sub_type: str = None, limit: str = None, updated_from: str = None, updated_to: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='list_resource_instances')
    ...
    def create_resource_instance(self, name: str, target: str, resource_group: str, resource_plan_id: str, *, tags: List[str] = None, allow_cleanup: bool = None, parameters: dict = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='create_resource_instance')
        headers.update(sdk_headers)
    ...
    def get_resource_instance(self, id: str, **kwargs) -> DetailedResponse:
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='get_resource_instance')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/resource_instances/{0}'.format(*self.encode_path_vars(id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def delete_resource_instance(self, id: str, **kwargs) -> DetailedResponse:
        """
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='delete_resource_instance')
        headers.update(sdk_headers)
    ...
    def update_resource_instance(self, id: str, *, name: str = None, parameters: dict = None, resource_plan_id: str = None, allow_cleanup: bool = None, **kwargs) -> DetailedResponse:
        """
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='update_resource_instance')
        headers.update(sdk_headers)
    ...
    def list_resource_keys(self, *, guid: str = None, name: str = None, resource_group_id: str = None, resource_id: str = None, limit: str = None, updated_from: str = None, updated_to: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='list_resource_keys')
        headers.update(sdk_headers)
    ...
    def create_resource_key(self, name: str, source: str, *, parameters: 'ResourceKeyPostParameters' = None, role: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='create_resource_key')
        headers.update(sdk_headers)
    ...
    def get_resource_key(self, id: str, **kwargs) -> DetailedResponse:
        ...
        url = '/resource_keys/{0}'.format(*self.encode_path_vars(id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def delete_resource_key(self, id: str, **kwargs) -> DetailedResponse:
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='delete_resource_key')
        headers.update(sdk_headers)
    ...
    def update_resource_key(self, id: str, name: str, **kwargs) -> DetailedResponse:
        ...
        if name is None:
            raise ValueError('name must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='update_resource_key')
        headers.update(sdk_headers)
    ...
    def list_resource_bindings(self, *, guid: str = None, name: str = None, resource_group_id: str = None, resource_id: str = None, region_binding_id: str = None, limit: str = None, updated_from: str = None, updated_to: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='list_resource_bindings')
        headers.update(sdk_headers)
    ...
    def create_resource_binding(self, source: str, target: str, *, name: str = None, parameters: 'ResourceBindingPostParameters' = None, role: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if parameters is not None:
            parameters = convert_model(parameters)
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='create_resource_binding')
        headers.update(sdk_headers)
    ...
    def get_resource_binding(self, id: str, **kwargs) -> DetailedResponse:
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='get_resource_binding')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/resource_bindings/{0}'.format(*self.encode_path_vars(id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def delete_resource_binding(self, id: str, **kwargs) -> DetailedResponse:
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='delete_resource_binding')
        headers.update(sdk_headers)
    ...
    def list_resource_aliases(self, *, guid: str = None, name: str = None, resource_instance_id: str = None, region_instance_id: str = None, resource_id: str = None, resource_group_id: str = None, limit: str = None, updated_from: str = None, updated_to: str = None, **kwargs) -> DetailedResponse:
        """
    ...
    def get_resource_alias(self, id: str, **kwargs) -> DetailedResponse:
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='get_resource_alias')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/resource_aliases/{0}'.format(*self.encode_path_vars(id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def delete_resource_alias(self, id: str, **kwargs) -> DetailedResponse:
        """
        ...
        if id is None:
            raise ValueError('id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='delete_resource_alias')
        headers.update(sdk_headers)
    ...
    def update_resource_alias(self, id: str, name: str, **kwargs) -> DetailedResponse:
        ...
        if name is None:
            raise ValueError('name must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='update_resource_alias')
        headers.update(sdk_headers)
    ...
    def list_reclamations(self, *, account_id: str = None, resource_instance_id: str = None, **kwargs) -> DetailedResponse:
        """
    ...
    def run_reclamation_action(self, id: str, action_name: str, *, request_by: str = None, comment: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V2', operation_id='run_reclamation_action')
        headers.update(sdk_headers)
        ...
        url = '/v1/reclamations/{0}/actions/{1}'.format(*self.encode_path_vars(id, action_name))
        request = self.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
...
class Credentials():
    ...
    def __init__(self, *, apikey: str = None, iam_apikey_description: str = None, iam_apikey_name: str = None, iam_role_crn: str = None, iam_serviceid_crn: str = None, **kwargs) -> None:
        """
...
class PlanHistoryItem():
    ...
    def __init__(self, resource_plan_id: str, start_date: datetime) -> None:
        """
...
class Reclamation():
    ...
    :attr str target_time: (optional) The target time that the reclamation retention
          period end.
    :attr str custom_properties: (optional) The custom properties of the
          reclamation.
    ...
    def __init__(self, *, id: str = None, entity_id: str = None, entity_type_id: str = None, entity_crn: str = None, resource_instance_id: object = None, resource_group_id: str = None, account_id: str = None, policy_id: str = None, state: str = None, target_time: str = None, custom_properties: str = None, created_at: datetime = None, created_by: str = None, updated_at: datetime = None, updated_by: str = None) -> None:
        """
        ...
        :param str custom_properties: (optional) The custom properties of the
               reclamation.
    ...
    def from_dict(cls, _dict: Dict) -> 'Reclamation':
        ...
        if 'resource_instance_id' in _dict:
            args['resource_instance_id'] = object.from_dict(_dict.get('resource_instance_id'))
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'resource_instance_id') and self.resource_instance_id is not None:
            _dict['resource_instance_id'] = self.resource_instance_id.to_dict()
...
class ResourceAlias():
    ...
    def __init__(self, *, id: str = None, guid: str = None, crn: str = None, url: str = None, name: str = None, account_id: str = None, resource_group_id: str = None, resource_group_crn: str = None, target_crn: str = None, state: str = None, resource_instance_id: str = None, region_instance_id: str = None, resource_instance_url: str = None, resource_bindings_url: str = None, resource_keys_url: str = None, created_at: datetime = None, updated_at: datetime = None, deleted_at: datetime = None) -> None:
        """
...
class ResourceAliasesList():
    ...
    :attr float rows_count: The number of resource aliases in `resources`.
    """

    def __init__(self, next_url: str, resources: List['ResourceAlias'], rows_count: float) -> None:
        """
        ...
        :param float rows_count: The number of resource aliases in `resources`.
        """
...
class ResourceBinding():
    ...
    def __init__(self, *, id: str = None, guid: str = None, crn: str = None, url: str = None, name: str = None, account_id: str = None, resource_group_id: str = None, source_crn: str = None, target_crn: str = None, region_binding_id: str = None, state: str = None, credentials: 'Credentials' = None, iam_compatible: bool = None, resource_alias_url: str = None, created_at: datetime = None, updated_at: datetime = None, deleted_at: datetime = None) -> None:
        """
...
class ResourceBindingPostParameters():
    ...
    def __init__(self, *, serviceid_crn: str = None) -> None:
        """
...
class ResourceBindingsList():
    ...
    :attr float rows_count: The number of resource bindings in `resources`.
    """

    def __init__(self, next_url: str, resources: List['ResourceBinding'], rows_count: float) -> None:
        """
        Initialize a ResourceBindingsList object.

        :param str next_url: The URL for requesting the next page of results.
        :param List[ResourceBinding] resources: A list of resource bindings.
        :param float rows_count: The number of resource bindings in `resources`.
        """
        self.next_url = next_url
        self.resources = resources
        self.rows_count = rows_count
...
class ResourceInstance():
    ...
    def __init__(self, *, id: str = None, guid: str = None, crn: str = None, url: str = None, name: str = None, account_id: str = None, resource_group_id: str = None, resource_group_crn: str = None, resource_id: str = None, resource_plan_id: str = None, target_crn: str = None, state: str = None, type: str = None, sub_type: str = None, allow_cleanup: bool = None, last_operation: dict = None, dashboard_url: str = None, plan_history: List['PlanHistoryItem'] = None, resource_aliases_url: str = None, resource_bindings_url: str = None, resource_keys_url: str = None, created_at: datetime = None, updated_at: datetime = None, deleted_at: datetime = None) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'ResourceInstance':
        ...
        if 'last_operation' in _dict:
            args['last_operation'] = {k : object.from_dict(v) for k,v in _dict.get('last_operation')}
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'last_operation') and self.last_operation is not None:
            _dict['last_operation'] = {k : v.to_dict() for k,v in self.last_operation.items()}
...
class ResourceInstancesList():
    ...
    def __init__(self, next_url: str, resources: List['ResourceInstance'], rows_count: int) -> None:
        """
...
class ResourceKey():
    ...
    def __init__(self, *, id: str = None, guid: str = None, crn: str = None, url: str = None, name: str = None, account_id: str = None, resource_group_id: str = None, source_crn: str = None, state: str = None, credentials: 'Credentials' = None, iam_compatible: bool = None, resource_instance_url: str = None, created_at: datetime = None, updated_at: datetime = None, deleted_at: datetime = None) -> None:
        """
...
class ResourceKeysList():
    ...
    :attr float rows_count: The number of resource keys in `resources`.
    """

    def __init__(self, next_url: str, resources: List['ResourceKey'], rows_count: float) -> None:
        """
        Initialize a ResourceKeysList object.

        :param str next_url: The URL for requesting the next page of results.
        :param List[ResourceKey] resources: A list of resource keys.
        :param float rows_count: The number of resource keys in `resources`.
        """
        self.next_url = next_url
        self.resources = resources
        self.rows_count = rows_count
