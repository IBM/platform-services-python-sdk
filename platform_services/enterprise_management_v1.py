...
class EnterpriseManagementV1(BaseService):
    ...
    def create_account_group(self, parent: str, name: str, primary_contact_iam_id: str, **kwargs) -> DetailedResponse:
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='create_account_group')
    ...
    def list_account_groups(self, *, enterprise_id: str = None, parent_account_group_id: str = None, parent: str = None, limit: int = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_account_groups')
        headers.update(sdk_headers)
    ...
    def get_account_group_by_id(self, account_group_id: str, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_account_group_by_id')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/account-groups/{0}'.format(*self.encode_path_vars(account_group_id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def update_account_group(self, account_group_id: str, *, name: str = None, primary_contact_iam_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if account_group_id is None:
            raise ValueError('account_group_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='update_account_group')
        headers.update(sdk_headers)
    ...
    def get_account_group_permissible_actions(self, account_group_id: str, *, actions: List[str] = None, **kwargs) -> DetailedResponse:
        """
        ...
        if account_group_id is None:
            raise ValueError('account_group_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_account_group_permissible_actions')
        headers.update(sdk_headers)
        ...
        url = '/account-groups/{0}/permissible-actions'.format(*self.encode_path_vars(account_group_id))
        request = self.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def import_account_to_enterprise(self, enterprise_id: str, account_id: str, *, parent: str = None, billing_unit_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='import_account_to_enterprise')
        headers.update(sdk_headers)
        ...
        url = '/enterprises/{0}/import/accounts/{1}'.format(*self.encode_path_vars(enterprise_id, account_id))
    ...
    def create_account(self, parent: str, name: str, owner_iam_id: str, **kwargs) -> DetailedResponse:
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='create_account')
        headers.update(sdk_headers)
    ...
    def list_accounts(self, *, enterprise_id: str = None, account_group_id: str = None, parent: str = None, limit: int = None, **kwargs) -> DetailedResponse:
        """
        ...
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='list_accounts')
        headers.update(sdk_headers)
    ...
    def get_account_by_id(self, account_id: str, **kwargs) -> DetailedResponse:
        """
        Get account by ID.
        ...
        if account_id is None:
            raise ValueError('account_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_account_by_id')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/accounts/{0}'.format(*self.encode_path_vars(account_id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def get_account_permissible_actions(self, account_id: str, *, actions: List[str] = None, **kwargs) -> DetailedResponse:
        """
        ...
        if account_id is None:
            raise ValueError('account_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_account_permissible_actions')
        headers.update(sdk_headers)
        ...
        url = '/accounts/{0}/permissible-actions'.format(*self.encode_path_vars(account_id))
        request = self.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
    ...
    def create_enterprise(self, source_account_id: str, name: str, primary_contact_iam_id: str, *, domain: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if primary_contact_iam_id is None:
            raise ValueError('primary_contact_iam_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='create_enterprise')
        headers.update(sdk_headers)
    ...
    def list_enterprises(self, *, enterprise_account_id: str = None, account_group_id: str = None, account_id: str = None, limit: int = None, **kwargs) -> DetailedResponse:
        """
    ...
    def get_enterprise(self, enterprise_id: str, **kwargs) -> DetailedResponse:
        ...
        if enterprise_id is None:
            raise ValueError('enterprise_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_enterprise')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/enterprises/{0}'.format(*self.encode_path_vars(enterprise_id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def update_enterprise(self, enterprise_id: str, *, name: str = None, domain: str = None, primary_contact_iam_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        if enterprise_id is None:
            raise ValueError('enterprise_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='update_enterprise')
        headers.update(sdk_headers)
    ...
    def get_enterprise_permissible_actions(self, enterprise_id: str, *, actions: List[str] = None, **kwargs) -> DetailedResponse:
        """
        ...
        if enterprise_id is None:
            raise ValueError('enterprise_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_enterprise_permissible_actions')
        headers.update(sdk_headers)
        ...
        url = '/enterprises/{0}/permissible-actions'.format(*self.encode_path_vars(enterprise_id))
        request = self.prepare_request(method='POST',
                                       url=url,
                                       headers=headers,
                                       data=data)
...
class AccountGroupResponse():
    ...
    def __init__(self, *, url: str = None, id: str = None, crn: str = None, parent: str = None, enterprise_account_id: str = None, enterprise_id: str = None, enterprise_path: str = None, name: str = None, state: str = None, primary_contact_iam_id: str = None, primary_contact_email: str = None, created_at: str = None, created_by: str = None, updated_at: str = None, updated_by: str = None) -> None:
        """
...
class EnterpriseResponse():
    ...
    def __init__(self, *, url: str = None, id: str = None, enterprise_account_id: str = None, crn: str = None, name: str = None, domain: str = None, state: str = None, primary_contact_iam_id: str = None, primary_contact_email: str = None, created_at: str = None, created_by: str = None, updated_at: str = None, updated_by: str = None) -> None:
        """
...
class ListAccountGroupsResponse():
    ...
    def __init__(self, *, rows_count: int = None, next_url: str = None, resources: List['ListAccountGroupsResources'] = None) -> None:
        """
...
class ListAccountsResponse():
    ...
    def __init__(self, *, rows_count: int = None, next_url: str = None, resources: List['ListAccountResources'] = None) -> None:
        """
...
class ListEnterprisesResponse():
    ...
    def __init__(self, *, rows_count: int = None, next_url: str = None, resources: List['ListEnterpriseResources'] = None) -> None:
        """
