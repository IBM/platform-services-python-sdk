...
class EnterpriseBillingUnitsV1(BaseService):
    ...
    def get_billing_option_by_query(self, billing_unit_id: str, **kwargs) -> DetailedResponse:
        """
        ...
        :rtype: DetailedResponse with `dict` result representing a `BillingOption` object
        """

        if billing_unit_id is None:
            raise ValueError('billing_unit_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_billing_option_by_query')
    ...
    def get_billing_unit_by_id(self, billing_unit_id: str, **kwargs) -> DetailedResponse:
        """
        ...
        if billing_unit_id is None:
            raise ValueError('billing_unit_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_billing_unit_by_id')
        headers.update(sdk_headers)

        if 'headers' in kwargs:
            headers.update(kwargs.get('headers'))

        url = '/v1/billing-units/{0}'.format(*self.encode_path_vars(billing_unit_id))
        request = self.prepare_request(method='GET',
                                       url=url,
                                       headers=headers)
    ...
    def get_billing_unit_by_query(self, *, account_id: str = None, enterprise_id: str = None, account_group_id: str = None, **kwargs) -> DetailedResponse:
        """
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ResponseBillingUnitsByQuery` object
        """

        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_billing_unit_by_query')
        headers.update(sdk_headers)
    ...
    def get_credit_pools(self, billing_unit_id: str, *, date: str = None, type: str = None, **kwargs) -> DetailedResponse:
        """
        Get credit pools.
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ResponseCreditPoolsByQuery` object
        """

        if billing_unit_id is None:
            raise ValueError('billing_unit_id must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_credit_pools')
        headers.update(sdk_headers)
...
class BillingOption():
    ...
    :attr str start_date: (optional) The start date of billing option.
    :attr str end_date: (optional) The end date of billing option.
    ...
    :attr object payment_instrument: (optional) The payment method for support.
    :attr float duration_in_months: (optional) The duration of the billing options
          in months.
    :attr float line_item_id: (optional) The line item ID for support.
    :attr object billing_system: (optional) The support billing system.
    :attr str renewal_mode_code: (optional) The renewal code for support. This code
          ...
          so on.
    :attr str updated_at: (optional) The date when the billing option was updated.
    """

    def __init__(self, *, id: str = None, billing_unit_id: str = None, start_date: str = None, end_date: str = None, state: str = None, type: str = None, category: str = None, payment_instrument: object = None, duration_in_months: float = None, line_item_id: float = None, billing_system: object = None, renewal_mode_code: str = None, updated_at: str = None) -> None:
        """
        ...
        :param str billing_unit_id: (optional) The ID of the billing unit that's
               associated with the billing option.
        :param str start_date: (optional) The start date of billing option.
        :param str end_date: (optional) The end date of billing option.
        ...
        :param object payment_instrument: (optional) The payment method for
               support.
        :param float duration_in_months: (optional) The duration of the billing
               options in months.
        :param float line_item_id: (optional) The line item ID for support.
        :param object billing_system: (optional) The support billing system.
        :param str renewal_mode_code: (optional) The renewal code for support. This
               ...
               monthly, and so on.
        :param str updated_at: (optional) The date when the billing option was
               updated.
        """
        self.id = id
    ...
    def from_dict(cls, _dict: Dict) -> 'BillingOption':
        ...
        if 'start_date' in _dict:
            args['start_date'] = _dict.get('start_date')
        if 'end_date' in _dict:
            args['end_date'] = _dict.get('end_date')
        if 'state' in _dict:
        ...
        if 'payment_instrument' in _dict:
            args['payment_instrument'] = object.from_dict(_dict.get('payment_instrument'))
        ...
        if 'billing_system' in _dict:
            args['billing_system'] = object.from_dict(_dict.get('billing_system'))
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'payment_instrument') and self.payment_instrument is not None:
            _dict['payment_instrument'] = self.payment_instrument.to_dict()
        ...
        if hasattr(self, 'billing_system') and self.billing_system is not None:
            _dict['billing_system'] = self.billing_system.to_dict()
...
class BillingUnit():
    ...
    :attr str created_at: (optional) The creation date of the billing unit.
    """

    def __init__(self, *, id: str = None, crn: str = None, name: str = None, enterprise_id: str = None, currency_code: str = None, country_code: str = None, master: bool = None, created_at: str = None) -> None:
        """
        ...
        :param str created_at: (optional) The creation date of the billing unit.
        """
        self.id = id
        self.crn = crn
        self.name = name
...
class CreditPoolOverage():
    ...
    :attr List[object] resources: (optional) A list of resources that generated
          overage.
    """

    def __init__(self, *, cost: float = None, resources: List[object] = None) -> None:
        """
        Initialize a CreditPoolOverage object.

        :param float cost: (optional) The number of credits used as overage.
        :param List[object] resources: (optional) A list of resources that
               generated overage.
        """
        self.cost = cost
...
class CreditPool():
    ...
    def __init__(self, *, type: str = None, currency_code: str = None, billing_unit_id: str = None, term_credits: List['TermCredits'] = None, overage: 'CreditPoolOverage' = None) -> None:
        """
...
class ResponseBillingUnitsByQuery():
    """
    Aggregated usage and charges for all the plans in the account.

    :attr float rows_count: (optional) A count of the billing units that were found
          by the query.
    ...
    def __init__(self, *, rows_count: float = None, next_url: str = None, resources: List['BillingUnit'] = None) -> None:
        """
        Initialize a ResponseBillingUnitsByQuery object.

        :param float rows_count: (optional) A count of the billing units that were
               found by the query.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ResponseBillingUnitsByQuery':
        """Initialize a ResponseBillingUnitsByQuery object from a json dictionary."""
        args = {}
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ResponseBillingUnitsByQuery object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ResponseBillingUnitsByQuery') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ResponseBillingUnitsByQuery') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class ResponseCreditPoolsByQuery():
    """
    Aggregated usage and charges for all the plans in the account.

    :attr float rows_count: (optional) The number of credit pools that were found by
          the query.
    ...
    def __init__(self, *, rows_count: float = None, next_url: str = None, resources: List['CreditPool'] = None) -> None:
        """
        Initialize a ResponseCreditPoolsByQuery object.

        :param float rows_count: (optional) The number of credit pools that were
               found by the query.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ResponseCreditPoolsByQuery':
        """Initialize a ResponseCreditPoolsByQuery object from a json dictionary."""
        args = {}
        if 'rows_count' in _dict:
            args['rows_count'] = _dict.get('rows_count')
        if 'next_url' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ResponseCreditPoolsByQuery object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ResponseCreditPoolsByQuery') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ResponseCreditPoolsByQuery') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class TermCredits():
    ...
    :attr str category: (optional) The category of the credit pool. The valid values
          ...
          support credit.
    :attr str start_date: (optional) The start date of the term in ISO format.
    :attr str end_date: (optional) The end date of the term in ISO format.
    ...
    :attr float current_balance: (optional) The balance of remaining credit in the
          subscription term.
    :attr List[object] resources: (optional) A list of resources that used credit
          during the month.
    """

    def __init__(self, *, billing_option_id: str = None, category: str = None, start_date: str = None, end_date: str = None, total_credits: float = None, starting_balance: float = None, used_credits: float = None, current_balance: float = None, resources: List[object] = None) -> None:
        """
        ...
        :param str start_date: (optional) The start date of the term in ISO format.
        :param str end_date: (optional) The end date of the term in ISO format.
        ...
        :param List[object] resources: (optional) A list of resources that used
