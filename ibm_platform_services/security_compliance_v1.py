...
class SecurityComplianceV1(BaseService):
    """The Security Compliance V1 service."""

    DEFAULT_SERVICE_URL = None
    DEFAULT_SERVICE_NAME = 'security_compliance'

    @classmethod
    def new_instance(cls,
                     service_name: str = DEFAULT_SERVICE_NAME,
                    ) -> 'SecurityComplianceV1':
        """
        Return a new client for the Security Compliance service using the specified
    ...
    def __init__(self,
        ...
        """
        Construct a new client for the Security Compliance service.
