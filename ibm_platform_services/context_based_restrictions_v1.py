...
class ContextBasedRestrictionsV1(BaseService):
    ...
    DEFAULT_SERVICE_URL = 'https://context-based-restrictions.cloud.ibm.com'
...
class AddressServiceRef(Address):
    ...
    :attr str type: The type of address.
    :attr ServiceRefValue value: A service reference value.
    """

    def __init__(self,
                 type: str,
                 value: 'ServiceRefValue') -> None:
        """
        Initialize a AddressServiceRef object.

        :param str type: The type of address.
        :param ServiceRefValue value: A service reference value.
        """
        # pylint: disable=super-init-not-called
        self.type = type
        self.value = value
    ...
    def from_dict(cls, _dict: Dict) -> 'AddressServiceRef':
        ...
        if 'value' in _dict:
            args['value'] = ServiceRefValue.from_dict(_dict.get('value'))
        else:
            raise ValueError('Required property \'value\' not present in AddressServiceRef JSON')
        return cls(**args)
