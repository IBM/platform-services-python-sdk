...
class TestListAvailableServicerefTargets:
    ...
    def test_list_available_serviceref_targets_all_params(self):
        ...
        mock_response = '{"count": 5, "targets": [{"service_name": "service_name", "service_type": "service_type", "locations": [{"display_name": "display_name", "kind": "kind", "name": "name"}], "display_name": "display_name"}]}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestGetServicerefTarget:
    ...
    def test_get_serviceref_target_all_params(self):
        ...
        mock_response = '{"service_name": "service_name", "service_type": "service_type", "locations": [{"display_name": "display_name", "kind": "kind", "name": "name"}], "display_name": "display_name"}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestModel_ServiceRefTarget:
    ...
    def test_service_ref_target_serialization(self):
        ...
        service_ref_target_model_json['display_name'] = 'testString'
...
class TestModel_ServiceRefTargetList:
    ...
    def test_service_ref_target_list_serialization(self):
        ...
        service_ref_target_model['display_name'] = 'testString'
