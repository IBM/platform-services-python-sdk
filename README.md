...
# IBM Cloud Platform Services Python SDK Version 0.17.18
...
```bash
pip install --upgrade "ibm-platform-services>=0.17.18"
```

or

```bash
easy_install --upgrade "ibm-platform-services>=0.17.18"
```
