...
# IBM Cloud Platform Services Python SDK Version 0.10.0
...
```bash
pip install --upgrade "ibm_platform_services>=0.10.0"
```

or

```bash
easy_install --upgrade "ibm_platform_services>=0.10.0"
```
