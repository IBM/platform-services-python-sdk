...
# IBM Cloud Platform Services Python SDK Version 0.15.5
...
```bash
pip install --upgrade "ibm-platform-services>=0.15.5"
```

or

```bash
easy_install --upgrade "ibm-platform-services>=0.15.5"
```
