...
# IBM Cloud Platform Services Python SDK Version 0.12.1
...
```bash
pip install --upgrade "ibm-platform-services>=0.12.1"
```

or

```bash
easy_install --upgrade "ibm-platform-services>=0.12.1"
```
