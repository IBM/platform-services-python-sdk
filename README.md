...
# IBM Cloud Platform Services Python SDK Version 0.18.4
...
```bash
pip install --upgrade "ibm-platform-services>=0.18.4"
```

or

```bash
easy_install --upgrade "ibm-platform-services>=0.18.4"
```
